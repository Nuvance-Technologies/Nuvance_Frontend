...
const ProfileCard = ( {name, image , about, instagram, linkedin, github, mailid}: ProfileCardProps) => {
    return (
        <StyledWrapper>
            <div className="card">
                <button className="cursor-pointer mail">
                    <svg onClick={() => {window.location.href = `mailto:${mailid}`}} xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-mail"><rect width={20} height={16} x={2} y={4} rx={2} /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" /></svg>
                </button>
                ...
                <div className="bottom">
                    ...
                    <div className="bottom-bottom">
                        <div className="social-links-container cursor-pointer">
                            <svg onClick={() => {window.open(instagram)}} xmlns="http://www.w3.org/2000/svg" width={16} height="15.999" viewBox="0 0 16 15.999">
